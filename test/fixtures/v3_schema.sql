-- icarium schema v3 — for migration tests only.
-- Identical to v2 plus slug TEXT columns and partial unique indexes on tasks and knowledge.
-- The 3→4 migration drops these slug columns.
