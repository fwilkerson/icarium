...
Run `icarium ctx list` to load project-specific context. The `refinement` discipline is specific to creating tasks with icarium, the others are what the agent has learned working on the codebase.
